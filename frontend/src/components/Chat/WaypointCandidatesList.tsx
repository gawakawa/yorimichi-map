  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full rounded-lg border border-emerald-300 bg-emerald-100 px-4 py-3 text-sm font-medium text-emerald-700 transition-all hover:bg-emerald-200 disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-400 disabled:opacity-50"
      >
        寄り道を追加
      </button>
    </div>
